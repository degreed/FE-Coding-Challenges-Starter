...
import { MoviesDataAccessService } from './data-access.service';
...
describe('MoviesDataAccessService', () => {
  let spectator: SpectatorService<MoviesDataAccessService>;
  let service: MoviesDataAccessService;
  const createService = createServiceFactory({
    service: MoviesDataAccessService,
    imports: [],
    declarations: [],
